...
<body>
   ...
   <header>
		  ...
		  <h1 class="display-4"><i class="fas fa-school"></i>&nbsp; Schedule Of Classes!</h1>
		  ...
		  <a class="btn btn-success btn-lg" href="${pageContext.request.contextPath}/ScheduleController?action=ShowSchedule" role="button">Check The Schedules!</a>
		</div>
   </header>
