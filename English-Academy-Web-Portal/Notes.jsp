...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
				        ...
				        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
				          <a class="dropdown-item" href="${contextPath}/Contact.jsp"><i class="fas fa-sign-in-alt"></i>&nbsp; Sign In</a>
				        </div>
				      </li>
                </ul>
            </div>
   ...
   <header>
		  ...
		  <h1 class="display-4"><i class="fas fa-book"></i>&nbsp; Show Notes!</h1>
		  ...
		  <a class="btn btn-success btn-lg" href="${pageContext.request.contextPath}/NotesController?action=ShowNote" role="button">Check The Notes!</a>
		</div>
   </header>
