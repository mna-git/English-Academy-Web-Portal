...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
				        ...
				        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
				          <a class="dropdown-item" href="${contextPath}/Views/Dashboard.jsp"><i class="fas fa-sign-in-alt"></i>&nbsp; Sign In</a>
				        </div>
				      </li>
                </ul>
            </div>
   ...
   <header>
		  ...
		  <h1 class="display-4"><i class="fas fa-university"></i>&nbsp; About Us!</h1>
    ...
    <section>
        <div class="container">
            <hr>
            <h4 class="display-4"><i class="fab fa-studiovinari"></i></h4>
            <h4 class="display-4">Best English Academy Of the Country</h4>
            <p class="para-all">These are the current Best sellers among our Products, Hurry Before Stocks get over!</p>
        </div>
    </section>
    <br>
    <section>
    <div class="container">
    	<div class="row para-all">
		  <div class="col-sm-6">
		    <div class="card">
		      <div class="card-body">
		        <h5 class="card-title">Learn What we Do</h5>
