...
<body>
   ...
   <header>
		  ...
		  <h1 class="display-4"><i class="fas fa-file-invoice"></i>&nbsp; Past Papers!</h1>
		  ...
		  <a class="btn btn-success btn-lg" href="${pageContext.request.contextPath}/PapersController?action=ShowPaper" role="button">Check The Papers!</a>
		</div>
   </header>
